...
public class ServiceTaskExport implements ActivitiNamespaceConstants {
  ...
  public static void createServiceTask(EObject object, XMLStreamWriter xtw) throws Exception {
    ...
    boolean securityExtensionsAvailable = false;
    if(serviceTask.getSecurityExtensions() != null){
    	securityExtensionsAvailable = true;
    }
    ...
    if(executionListenersAvailable == true || fieldExtensionsAvailable == true || securityExtensionsAvailable == true) {
    ...
    SecurityExtensionExport.writeSecurityExtensions(xtw, serviceTask.getSecurityExtensions(), false);
