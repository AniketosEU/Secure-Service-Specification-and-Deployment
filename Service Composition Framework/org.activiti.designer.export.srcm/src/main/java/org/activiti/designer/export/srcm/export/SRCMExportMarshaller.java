 ...
 * 
 */
public class SRCMExportMarshaller extends AbstractExportMarshaller implements ActivitiNamespaceConstants {

  private static final String FILENAME_PATTERN = ExportMarshaller.PLACEHOLDER_ORIGINAL_FILENAME_WITHOUT_EXTENSION + ".srcm";
  ...
  /**
	 * 
	 */
  public SRCMExportMarshaller() {
  }

  @Override
  public String getMarshallerName() {
    return "Activiti Designer SRCM";
  }

  @Override
  public String getFormatName() {
    return "Activiti SRCM";
  }
  ...
  public void marshallDiagram(Diagram diagram, IProgressMonitor monitor) {
    ...
    this.monitor.beginTask("Exporting to SRCM file", WORK_TOTAL);
    
    System.out.println("Exporting to SRCM file");
  ...
  private void marshallBPMNDiagram() {
    try {
      ...
      xtw.writeNamespace("aniketos", "http://aniketos.eu");
