...
public class CreateBoundaryErrorThreatFeature extends AbstractCreateBPMNFeature {
	
	public static final String FEATURE_ID_KEY = "boundarythreaterror";

	public CreateBoundaryErrorThreatFeature(IFeatureProvider fp) {
		// set name and description of the creation feature
		super(fp, "ThreatEvent", "Add a threat event");
	}

	public boolean canCreate(ICreateContext context) {
	  Object parentObject = getBusinessObjectForPictogramElement(context.getTargetContainer());
    if (parentObject instanceof SubProcess == true ||
        parentObject instanceof CallActivity == true || parentObject instanceof ServiceTask == true) {
      return true;
    }
    return false;
	}
	...
	public Object[] create(ICreateContext context) {
	  ThreatEvent boundaryEvent = AniketosFactory.eINSTANCE.createThreatEvent();
