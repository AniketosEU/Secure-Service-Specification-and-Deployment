...
public class ActivitiSavePreferencesPageInitializer extends AbstractPreferenceInitializer {
  ...
  public void initializeDefaultPreferences() {
    ...
    store.setDefault(PreferencesUtil.getExportMarshallerPreferenceId("Activiti Designer SRCM"), true);

    //Alfresco has been disabled
    store.setDefault(Preferences.ALFRESCO_ENABLE.getPreferenceId(), false);
