...
public class EnvironmentClient implements Runnable {
	...
	public void registerForAlert(String serviceId, String alertType, 
                                 String description, int importanceThreshold) {
		if (connectionIsReady) {
			Subscription sub = new Subscription(serviceId, alertType, description, 
                                                importanceThreshold, session,
                                                eventListener);
	...
	public void run() {
		...
		try {
            ...
            System.out.println("Notification session created");
