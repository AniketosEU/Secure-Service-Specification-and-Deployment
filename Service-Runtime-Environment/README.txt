...
-serviceruntimenotification (MAVEN): Bundle that connects SRE with the Notification module
...
-serviceruntimeeventlistener (MAVEN): Bundle that provides an interface for listening to events
